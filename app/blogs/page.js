  ...
  return (
    <>
      ...
      <div className="landing-page min-h-screen">
        <div className="grid gap-6 lg:relative justify-center items-center md:items-start pt-24 md:pt-40 mx-2 md:mx-56 pb-4 md:pb-0 border-opacity-20 border-b border-white">
          ...
          <Image
            ...
            alt="blog"
          />
          <p className="text-white lg:absolute lg:bottom-4 font-medium md:font-semibold tracking-wide font-poppins test-base md:text-2xl z-30">
        ...
        <div className="grid lg:grid-cols-3 gap-2 pt-4 mx-2 md:mx-56">
          {blogPost}
        </div>
        <LaunchFooter />
      </div>
